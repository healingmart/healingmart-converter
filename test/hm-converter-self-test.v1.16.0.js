/*
 * HealingMart Converter Self Test v1.16.0
 * Target release: HealingMart Converter v3.43.0
 *
 * Purpose:
 * - Batch-check registry structure
 * - Verify 670 active / 2 server-required
