/*
 * HealingMart Converter Self Test v1.14.0
 * Target release: HealingMart Converter v3.41.0
 *
 * Purpose:
 * - Batch-check registry structure
 * - Verify 610 active / 2 server-required
