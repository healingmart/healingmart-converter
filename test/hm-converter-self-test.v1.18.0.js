/*
 * HealingMart Converter Self Test v1.18.0
 * Target release: HealingMart Converter v3.45.0
 *
 * Purpose:
 * - Batch-check registry structure
 * - Verify 670 active / 2 server-required and v3.45 interaction stability markers
...
(function (w, d) {
  ...
  function testBrowserFeatures() {
    ...
    info(section, "안정화 검사", "입력·결과·복사·날짜·로마 숫자·연비·단위 전환 안정화 마커 포함");
