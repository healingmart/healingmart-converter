/*
 * HealingMart Converter Self Test v1.0.0
 * Target release: HealingMart Converter v3.27.0
 *
 * Purpose:
 * - Batch-check registry structure
 * - Verify 190 active / 2 server-required
 ...
 *
 * This test does NOT claim to re-run all 190 file conversions end-to-end.
 * It automates the static/integration checks that were previously done manually.
 */
(function (w, d) {
  "use strict";

  var CONFIG = {"selfTestVersion":"1.0.0","release":"3.27.0","registryVersion":"3.6.0","baseUrl":"https://healingmart.github.io/healingmart-converter","expected":{"total":192,"active":190,"coming":2,"comingIds":["epub-mobi","epub-azw3"],"serverBackend":"Calibre ebook-convert","categoryCounts":{"pdf":{"total":17,"active":17,"coming":0},"document":{"total":16,"active":16,"coming":0},"image":{"total":28,"active":28,"coming":0},"video":{"total":16,"active":16,"coming":0},"audio":{"total":16,"active":16,"coming":0},"hwp":{"total":10,"active":10,"coming":0},"data":{"total":16,"active":16,"coming":0},"subtitle":{"total":10,"active":10,"coming":0},"ebook":{"total":12,"active":10,"coming":2},"archive":{"total":10,"active":10,"coming":0},"font":{"total":10,"active":10,"coming":0},"developer":{"total":12,"active":12,"coming":0},"color":{"total":12,"active":12,"coming":0},"unit":{"total":0,"active":0,"coming":0},"other":{"total":7,"active":7,"coming":0}}},"files":{"dist/data/hm-converter-registry.v2.js":"2396ca2848f70c1b247141d3d2bf4a7f882ac4426420f63a42273653c78ec599","dist/js/engines/hm-engine-archive.v1.1.0.js":"d3d5fa0b1ea6a1d2f27fac53d584cbe3c0e4392737d5b9ddbdd756341b658399","dist/js/engines/hm-engine-color.v1.0.0.js":"e55f93ad35ed3ff78098df9ef563886b5824002f79ed4644f76a3933bd733c70","dist/js/engines/hm-engine-data.v1.0.0.js":"a61f8d5119f9b4768ad3a05f2281914ffeba3b63e11cc76e78d3b5214385b946","dist/js/engines/hm-engine-document.v1.1.0.js":"f1fbe18821be52a193d9cfb074773060a3597ce7ed74e77696f4044281bf3198","dist/js/engines/hm-engine-ebook.v1.2.0.js":"b5205037843151e5d09d8e181641ad0410bb62a4c887fefc502c082c7267c568","dist/js/engines/hm-engine-font.v1.1.0.js":"1531f9b92bda78a2009b59f07700c9c11fc8a9529473735d1e404915b7818fde","dist/js/engines/hm-engine-hwpx.v1.2.0.js":"9f20609301fc8a93fc731a36f3253f742dbdd1b4b43f0205779d38fd8db4c779","dist/js/engines/hm-engine-image.v1.3.0.js":"dc728911856ad886b96e29c664e2dcc1d4aab675c1c63c2b895bf7b117e7ad7d","dist/js/engines/hm-engine-media.v1.0.0.js":"9a34989c6bd179fa14435201e6af82ccc633130a7f5a14e66065694b72a87930","dist/js/engines/hm-engine-office.v1.0.0.js":"977476322e4aa66425922dfa641c87fce62939071c56ed2ca770128e1ab057e9","dist/js/engines/hm-engine-pdf.v1.2.0.js":"5027362220c64c59884e171a8e88a9ac66b95749e457579eb742933c05c8116a","dist/js/engines/hm-engine-subtitle.v1.1.0.js":"378baba839d34217d078dceb1fae34f305691d056548e9f8f2d3ff599c273f2c"},"engines":{"archive":"dist/js/engines/hm-engine-archive.v1.1.0.js","color":"dist/js/engines/hm-engine-color.v1.0.0.js","data":"dist/js/engines/hm-engine-data.v1.0.0.js","document":"dist/js/engines/hm-engine-document.v1.1.0.js","ebook":"dist/js/engines/hm-engine-ebook.v1.2.0.js","font":"dist/js/engines/hm-engine-font.v1.1.0.js","hwp":"dist/js/engines/hm-engine-hwpx.v1.2.0.js","image":"dist/js/engines/hm-engine-image.v1.3.0.js","media":"dist/js/engines/hm-engine-media.v1.0.0.js","office":"dist/js/engines/hm-engine-office.v1.0.0.js","pdf":"dist/js/engines/hm-engine-pdf.v1.2.0.js","subtitle":"dist/js/engines/hm-engine-subtitle.v1.1.0.js"},"blogger":{"appId":"healingMartConverterApp","toolVersion":"3.27.0","representativeImageFragment":"ChatGPT%20Image%202026","adsenseClient":"ca-pub-8341470683891223","adsenseSlot":"5437512125","bottomBoundarySelector":"[data-hm-converter-bottom-boundary]","requiredCodeMarkers":["function jumpToApp(fixedTop)","setTimeout(run,120)","function repairRenderedEntities(root)","MutationObserver","y.status==='active'","if(x.engine==='office')return runConverterEngine('office',x);","if(x.category==='pdf')return runConverterEngine('pdf',x);","if(x.category==='video'||x.category==='audio')return runConverterEngine('media',x);"],"forbiddenStaleText":["HWP·Office·영상·오디오 변환은 정확성과 파일 보안을 확인한 뒤 순차적으로 열 예정입니다."]}};
  ...
  async function testRegistry() {
    ...
    activeRouteFailures.length
      ...
      : pass(section, "active 라우팅 누락", "190개 모두 detail() 대상 확인");
  ...
  function testBloggerPage() {
    ...
    html.indexOf(CONFIG.blogger.adsenseClient) >= 0 &&
    html.indexOf(CONFIG.blogger.adsenseSlot) >= 0
    ...
    CONFIG.blogger.requiredCodeMarkers.forEach(function (marker) {
      scripts.indexOf(marker) >= 0
        ? pass(section, "코드 마커", marker)
        : fail(section, "코드 마커", "누락: " + marker);
    });

    CONFIG.blogger.forbiddenStaleText.forEach(function (text) {
      (html.indexOf(text) < 0 && scripts.indexOf(text) < 0)
    ...
    Object.keys(CONFIG.engines).forEach(function (key) {
      var path = CONFIG.engines[key] + "?v=" + CONFIG.release;
      scripts.indexOf(path) >= 0
        ? pass(section, "ENGINE_FILES " + key, path)
        : fail(section, "ENGINE_FILES " + key, "현재 Blogger 코드에서 " + path + "를 찾지 못했습니다.");
    });
  ...
  function buildTextReport() {
    ...
    lines.push(
      "NOTE",
      "이 테스트는 Registry/라우팅/배포 파일 무결성/엔진 등록/Blogger 통합을 한꺼번에 검사합니다.",
      "190개 변환 조합에 실제 사용자 파일을 넣어 모두 변환하는 E2E 테스트를 대체하지는 않습니다."
    );
  ...
  async function run() {
    ...
    try {
      ...
      info(
        "테스트 도구",
        "검사 범위 안내",
        "정적/통합 검사를 자동화한 테스트입니다. 190개 변환기에 실제 파일을 넣는 전수 E2E 변환 테스트는 별도입니다."
      );
    } catch (error) {
