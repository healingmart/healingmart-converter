/*
 * HealingMart Converter Self Test v1.27.0
 * Target release: HealingMart Converter v3.54.0
 *
 * Purpose:
 * - Batch-check registry structure
 * - Verify 898 active / 2 server-required and v3.54.0 feature markers
 ...
 *
 * This test does NOT claim to re-run all 898 file conversions end-to-end.
 * It automates static and integration checks after deployment.
 */
(function (w, d) {
  "use strict";

  var CONFIG = {"selfTestVersion":"1.27.0","release":"3.54.0","registryVersion":"3.33.0","appVersion":"3.33.0","baseUrl":"https://healingmart.github.io/healingmart-converter","expected":{"total":900,"active":898,"coming":2,"comingIds":["epub-mobi","epub-azw3"],"newIds":["date-header-json","json-date-header","expires-header-json","json-expires-header","last-modified-header-json","json-last-modified-header","if-modified-since-header-json","json-if-modified-since-header","if-unmodified-since-header-json","json-if-unmodified-since-header","age-header-json","json-age-header","location-header-json","json-location-header","refresh-header-json","json-refresh-header","content-length-header-json","json-content-length-header","content-encoding-header-lines","lines-content-encoding-header","transfer-encoding-header-lines","lines-transfer-encoding-header","expect-header-json","json-expect-header","max-forwards-header-json","json-max-forwards-header","via-header-json","json-via-header","warning-header-json","json-warning-header","x-forwarded-host-header-json","json-x-forwarded-host-header","x-forwarded-proto-header-json","json-x-forwarded-proto-header","x-forwarded-port-header-json","json-x-forwarded-port-header","x-real-ip-header-json","json-x-real-ip-header","cdn-loop-header-json","json-cdn-loop-header","cache-status-header-json","json-cache-status-header","surrogate-control-header-json","json-surrogate-control-header","accept-ranges-header-lines","lines-accept-ranges-header","content-location-header-json","json-content-location-header","content-md5-header-json","json-content-md5-header","upgrade-insecure-requests-header-json","json-upgrade-insecure-requests-header","dnt-header-json","json-dnt-header","sec-gpc-header-json","json-sec-gpc-header","sec-websocket-key-header-json","json-sec-websocket-key-header","sec-websocket-accept-header-json","json-sec-websocket-accept-header","accept-ch-header-lines","lines-accept-ch-header","critical-ch-header-lines","lines-critical-ch-header","early-data-header-json","json-early-data-header","clear-site-data-header-json","json-clear-site-data-header","reporting-endpoints-header-json","json-reporting-endpoints-header","report-to-header-json","json-report-to-header","nel-header-json","json-nel-header","cross-origin-embedder-policy-header-json","json-cross-origin-embedder-policy-header","cross-origin-opener-policy-header-json","json-cross-origin-opener-policy-header","cross-origin-resource-policy-header-json","json-cross-origin-resource-policy-header","timing-allow-origin-header-lines","lines-timing-allow-origin-header","access-control-allow-credentials-header-json","json-access-control-allow-credentials-header","access-control-request-method-header-json","json-access-control-request-method-header","sourcemap-header-json","json-sourcemap-header","x-content-type-options-header-json","json-x-content-type-options-header","x-frame-options-header-json","json-x-frame-options-header","x-xss-protection-header-json","json-x-xss-protection-header","expect-ct-header-json","json-expect-ct-header","csp-report-only-header-json","json-csp-report-only-header","permissions-policy-report-only-header-json","json-permissions-policy-report-only-header","origin-agent-cluster-header-json","json-origin-agent-cluster-header","accept-patch-header-json","json-accept-patch
/engines/hm-engine-data.v1.2.0.js","document":"dist/js/engines/hm-engine-document.v1.1.0.js","ebook":"dist/js/engines/hm-engine-ebook.v1.2.1.js","font":"dist/js/engines/hm-engine-font.v1.1.0.js","hwp":"dist/js/engines/hm-engine-hwpx.v1.2.0.js","image":"dist/js/engines/hm-engine-image.v1.3.0.js","media":"dist/js/engines/hm-engine-media.v1.0.0.js","office":"dist/js/engines/hm-engine-office.v1.0.0.js","pdf":"dist/js/engines/hm-engine-pdf.v1.2.0.js","subtitle":"dist/js/engines/hm-engine-subtitle.v1.1.0.js"},"blogger":{"appId":"healingMartConverterApp","toolVersion":"3.54.0","representativeImageFragment":"ChatGPT%20Image%202026","adsenseClient":"ca-pub-8341470683891223","adsenseSlot":"5437512125","bottomBoundarySelector":"[data-hm-converter-bottom-boundary]","requiredCodeMarkers":["data-tool-version=\"3.54.0\"","version:\"3.54.0\"","function jumpToApp(fixedTop)","setTimeout(run,120)","function repairRenderedEntities(root)","MutationObserver","y.status==='active'","if(x.engine==='office')return runConverterEngine('office',x,token);","if(x.category==='pdf')return runConverterEngine('pdf',x,token);","if(x.category==='video'||x.category==='audio')return runConverterEngine('media',x,token);","hm-engine-data.v1.2.0.js?v=3.54.0","hm-converter-registry.v2.js?v=3.54.0","function hmSearchConverters(list,query,limit)","function hmDetectedConverters(list,file)","HM_SEARCH_ALIASES","function hmCopyText(value)","function hmCtrlEnter(input,run)","function hmValidDate(value)","data-copy disabled","변환 전후 바꾸기","연비 값은 0보다 커야 합니다.","로마 숫자는 1부터 3999까지","function loadScript(src,timeoutMs)","스크립트 로딩 시간이 초과되었습니다.","var HM_RENDER_TOKEN=0","function hmCurrentRender(token)","function runConverterEngine(name,x,token)","delete HM_ENGINE_LOADS[name]","role=\"button\" tabindex=\"0\" aria-label=\"파일을 선택하거나 끌어놓기\"","file.value=''","여러 파일 중 첫 파일만 확인했습니다","role=\"status\" aria-live=\"polite\"","hmSetStageBusy(false)","if(e==='query-json')","if(e==='text-base32')","if(e==='text-urls-extract')","if(e==='decimal-binary-number')","body:has(#healingMartConverterApp) .tocify-wrap","body:has(#healingMartConverterApp) .tocify-inner","body:has(#healingMartConverterApp) .tocify-title","if(e==='json-go-struct')","if(e==='json-form-urlencoded')","if(e==='http-json-fetch')","if(e==='ipv4-cidr-report')","if(e==='mac-report-json')","if(e==='http-status-json')","function hmV347Ipv6Parts(value)","if(e==='ipv6-expand')","if(e==='json-dns-a-record')","if(e==='lines-vary-header')","function hmV348ContentTypeJson(value)","if(e==='content-type-header-json')","if(e==='etag-header-json')","if(e==='json-retry-after')","if(e==='access-control-allow-origin-json')","if(e==='csp-header-json')","if(e==='permissions-policy-json')","if(e==='hsts-header-json')","if(e==='lines-x-forwarded-for')","function hmV349CacheJson(value)","if(e==='cache-control-header-json')","if(e==='accept-header-json')","if(e==='cookie-header-json')","if(e==='set-cookie-header-json')","if(e==='authorization-basic-json')","if(e==='www-authenticate-header-json')","if(e==='server-timing-header-json')","if(e==='origin-header-json')","if(e==='json-digest-header')","function hmV350HostJson(value)","if(e==='host-header-json')","if(e==='referer-header-json')","if(e==='user-agent-header-json')","if(e==='x-robots-tag-header-json')","if(e==='alt-svc-header-json')","if(e==='priority-header-json')","if(e==='prefer-header-json')","if(e==='preference-applied-header-json')","if(e==='te-header-lines')","if(e==='trailer-header-lines')","if(e==='connection-header-lines')","if(e==='upgrade-header-json')","if(e==='keep-alive-header-json')","if(e==='fetch-metadata-headers-json')","if(e==='json-client-hints-headers')","function hmV351HttpDateJson(value,name)","function hmV352ForwardedHostsJson(value)","function hmV353ReportingJson(value)","function hmV354XFrameJson(value)","if(e==='date-header-json')","if(e==='x-forwarded-host-header-json')","if(e==='reporting-endpoints-header-json')","if(e==='x-frame-options-header-json')","if(e==='json-want-digest-header')"],"forbiddenStaleText":["HWP·Office·영상·오디오 변환은 정확성과 파일 보안을 확인한 뒤 순차적으로 열 예정입니다.","?v=3.43.0","?v=3.44.0","?v=3.45.0","?v=3.46.0","?v=3.47.0","?v=3.48.0","data-tool-version=\"3.33.0\"","?v=3.49.0","?v=3.50.0","data-tool-version=\"3.50.0\""],"tocSelectors":["#toc",".toc","#auto-toc",".auto-toc",".post-toc",".toc-container",".table-of-contents","#toc-container","#toc_container",".tocify-wrap",".tocify-inner",".tocify-title"]},"engineVersions":{"archive":"1.1.0","color":"1.0.0","data":"1.2.0","document":"1.1.0","ebook":"1.2.1","font":"1.1.0","hwp":"1.2.0","image":"1.3.0","media":"1.0.0","office":"1.0.0","pdf":"1.2.0","subtitle":"1.1.0"}};
  ...
  async function testRegistry() {
    ...
    var releaseIds = CONFIG.expected.newIds || [];
    var missingNewIds = releaseIds.filter(function (id) {
      return ids.indexOf(id) < 0;
    });
    if (releaseIds.length) {
      missingNewIds.length
        ? fail(section, "릴리스 신규 ID", missingNewIds.join(", "))
        : pass(section, "릴리스 신규 ID", releaseIds.length + "개 ID 모두 확인");
    } else {
      info(section, "안정화 릴리스", "신규 변환기 없이 기존 " + converters.length + "개 Registry를 유지합니다.");
    }
  ...
  function testBrowserFeatures() {
    ...
    info(section, "안정화 검사", "비동기 엔진 안정화와 IPv6·DNS·HTTP 헤더 신규 변환 마커 포함");
  ...
  function buildTextReport() {
    ...
    lines.push(
      ...
      "현재 active 700개 변환기에 실제 사용자 파일을 넣어 모두 변환하는 전수 E2E 테스트를 대체하지는 않습니다."
    );
  ...
  async function run() {
    ...
    try {
      ...
      info(
        "테스트 도구",
        "검사 범위 안내",
        "정적/통합 검사를 자동화한 테스트입니다. 700개 변환기에 실제 파일을 넣는 전수 E2E 변환 테스트는 별도입니다."
      );
    } catch (error) {
