/*
 * HealingMart Converter Self Test v1.2.0
 * Target release: HealingMart Converter v3.29.0
 *
 * Purpose:
 * - Batch-check registry structure
 * - Verify 250 active / 2 server-required
 ...
 *
 * This test does NOT claim to re-run all 250 file conversions end-to-end.
 * It automates the static/integration checks that were previously done manually.
 */
(function (w, d) {
  "use strict";

  var CONFIG = {"selfTestVersion":"1.2.0","release":"3.29.0","registryVersion":"3.8.0","appVersion":"3.8.0","baseUrl":"https://healingmart.github.io/healingmart-converter","expected":{"total":252,"active":250,"coming":2,"comingIds":["epub-mobi","epub-azw3"],"newIds":["comma-line","semicolon-line","pipe-line","line-semicolon","line-pipe","line-sort-asc","line-sort-desc","line-reverse","duplicate-line-remove","whitespace-normalize","text-unicode-escape","unicode-escape-text","text-base64url","base64url-text","query-json","json-query","jsonl-json-array","json-array-jsonl","text-html-paragraph","html-paragraph-text","text-br","br-text","html-text","markdown-text","words-snake","snake-words","snake-camel","camel-snake","kebab-camel","camel-kebab"],"serverBackend":"Calibre ebook-convert","categoryCounts":{"pdf":{"total":17,"active":17,"coming":0},"document":{"total":16,"active":16,"coming":0},"image":{"total":44,"active":44,"coming":0},"video":{"total":16,"active":16,"coming":0},"audio":{"total":16,"active":16,"coming":0},"hwp":{"total":10,"active":10,"coming":0},"data":{"total":16,"active":16,"coming":0},"subtitle":{"total":10,"active":10,"coming":0},"ebook":{"total":12,"active":10,"coming":2},"archive":{"total":10,"active":10,"coming":0},"font":{"total":10,"active":10,"coming":0},"developer":{"total":50,"active":50,"coming":0},"color":{"total":12,"active":12,"coming":0},"unit":{"total":0,"active":0,"coming":0},"other":{"total":13,"active":13,"coming":0}}},"files":{"dist/data/hm-converter-registry.v2.js":"f143e495fe0fc21bce574f3ff2de5fb0380df9728be890e4ba47afc6de70c208","dist/js/hm-converter-app.v3.8.0.js":"56a8878524898b17e28e650b06f6681de5186cf01b02764e24565b65a7078ba6","dist/js/engines/hm-engine-archive.v1.1.0.js":"d3d5fa0b1ea6a1d2f27fac53d584cbe3c0e4392737d5b9ddbdd756341b658399","dist/js/engines/hm-engine-color.v1.0.0.js":"e55f93ad35ed3ff78098df9ef563886b5824002f79ed4644f76a3933bd733c70","dist/js/engines/hm-engine-data.v1.0.0.js":"a61f8d5119f9b4768ad3a05f2281914ffeba3b63e11cc76e78d3b5214385b946","dist/js/engines/hm-engine-document.v1.1.0.js":"f1fbe18821be52a193d9cfb074773060a3597ce7ed74e77696f4044281bf3198","dist/js/engines/hm-engine-ebook.v1.2.1.js":"dd2f8353aabe23cb5fbded006cfeb534c1c0649d3054d2f44551df901ed24433","dist/js/engines/hm-engine-font.v1.1.0.js":"1531f9b92bda78a2009b59f07700c9c11fc8a9529473735d1e404915b7818fde","dist/js/engines/hm-engine-hwpx.v1.2.0.js":"9f20609301fc8a93fc731a36f3253f742dbdd1b4b43f0205779d38fd8db4c779","dist/js/engines/hm-engine-image.v1.3.0.js":"dc728911856ad886b96e29c664e2dcc1d4aab675c1c63c2b895bf7b117e7ad7d","dist/js/engines/hm-engine-media.v1.0.0.js":"9a34989c6bd179fa14435201e6af82ccc633130a7f5a14e66065694b72a87930","dist/js/engines/hm-engine-office.v1.0.0.js":"977476322e4aa66425922dfa641c87fce62939071c56ed2ca770128e1ab057e9","dist/js/engines/hm-engine-pdf.v1.2.0.js":"5027362220c64c59884e171a8e88a9ac66b95749e457579eb742933c05c8116a","dist/js/engines/hm-engine-subtitle.v1.1.0.js":"378baba839d34217d078dceb1fae34f305691d056548e9f8f2d3ff599c273f2c"},"engines":{"archive":"dist/js/engines/hm-engine-archive.v1.1.0.js","color":"dist/js/engines/hm-engine-color.v1.0.0.js","data":"dist/js/engines/hm-engine-data.v1.0.0.js","document":"dist/js/engines/hm-engine-document.v1.1.0.js","ebook":"dist/js/engines/hm-engine-ebook.v1.2.1.js","font":"dist/js/engines/hm-engine-font.v1.1.0.js","hwp":"dist/js/engines/hm-engine-hwpx.v1.2.0.js","image":"dist/js/engines/hm-engine-image.v1.3.0.js","media":"dist/js/engines/hm-engine-media.v1.0.0.js","office":"dist/js/engines/hm-engine-office.v1.0.0.js","pdf":"dist/js/engines/hm-engine-pdf.v1.2.0.js","subtitle":"dist/js/engines/hm-engine-subtitle.v1.1.0.js"},"blogger":{"appId":"healingMartConverterApp","toolVersion":"3.29.0","representativeImageFragment":"ChatGPT%20Image%202026","adsenseClient":"ca-pub-8341470683891223","adsenseSlot":"5437512125","bottomBoundarySelector":"[data-hm-converter-bottom-boundary]","requiredCodeMarkers":["function jumpToApp(fixedTop)","setTimeout(run,120)","function repairRenderedEntities(root)","MutationObserver","y.status==='active'","if(x.engine==='office')return runConverterEngine('office',x);","if(x.category==='pdf')return runConverterEngine('pdf',x);","if(x.category==='video'||x.category==='audio')return runConverterEngine('media',x);","if(e==='query-json')","if(e==='camel-kebab')","if(f==='OCT')return 8","body:has(#healingMartConverterApp) .tocify-wrap","body:has(#healingMartConverterApp) .tocify-inner","body:has(#healingMartConverterApp) .tocify-title"],"forbiddenStaleText":["HWP·Office·영상·오디오 변환은 정확성과 파일 보안을 확인한 뒤 순차적으로 열 예정입니다."],"tocSelectors":["#toc",".toc","#auto-toc",".auto-toc",".post-toc",".toc-container",".table-of-contents","#toc-container","#toc_container",".tocify-wrap",".tocify-inner",".tocify-title"]},"engineVersions":{"archive":"1.1.0","color":"1.0.0","data":"1.0.0","document":"1.1.0","ebook":"1.2.1","font":"1.1.0","hwp":"1.2.0","image":"1.3.0","media":"1.0.0","office":"1.0.0","pdf":"1.2.0","subtitle":"1.1.0"}};
  ...
  async function testRegistry() {
    ...
    activeRouteFailures.length
      ...
      : pass(section, "active 라우팅 누락", "250개 모두 detail() 대상 확인");
  ...
  async function run() {
    ...
    try {
      ...
      info(
        "테스트 도구",
        "검사 범위 안내",
        "정적/통합 검사를 자동화한 테스트입니다. 250개 변환기에 실제 파일을 넣는 전수 E2E 변환 테스트는 별도입니다."
      );
    } catch (error) {
