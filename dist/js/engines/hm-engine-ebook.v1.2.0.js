/*
 * HealingMart Converter E-book Engine v1.2.0
 * TXT / HTML / DOCX -> EPUB
 * EPUB -> TXT / PDF
 */
(function (w) {
    ...
    ctx.stage.innerHTML =
      '<div class="hm-fx-detail">' +
        ...
        '<div class="hm-eb-box">' +
          ...
          '</div><div class="hm-eb-version">E-book Engine v1.2.0</div>' +
        '</div></div>';
    ...
    ctx.stage.innerHTML =
      '<div class="hm-fx-detail">' +
        ...
        '<div class="hm-eb-box">' +
          ...
          '<div class="hm-eb-version">E-book Engine v1.1.0</div>' +
        '</div></div>';
    ...
    ctx.stage.innerHTML =
      '<div class="hm-fx-detail">' +
        ...
        '<div class="hm-eb-box">' +
          ...
          '<div class="hm-eb-version">E-book Engine v1.2.0 · mobi-parser 0.4.6</div>' +
        '</div>' +
      '</div>';
