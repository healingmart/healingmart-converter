/*
 * HealingMart Converter Font Engine v1.0.0
 * TTF / OTF / WOFF / WOFF2 / EOT
 * Browser-side conversion with fonteditor-core 2.6.3
 */
(function (w) {
  "use strict";
  ...
  async function convertFont(file, from, to, onStatus) {
    ...
    if (to === "otf") {
      throw new Error("현재 브라우저 엔진은 OTF 쓰기를 지원하지 않습니다.");
    }
      ...
      ctx.stage.innerHTML =
        '<div class="hm-fx-detail">' +
          ...
          '<div class="hm-ft-box">' +
            ...
            '<div class="hm-ft-version">Font Engine v1.0.0</div>' +
          '</div>' +
        '</div>';
