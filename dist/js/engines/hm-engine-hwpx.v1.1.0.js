/*
 * HealingMart Converter HWP/HWPX Engine v1.1.0
    ...
    ctx.stage.innerHTML =
      '<div class="hm-fx-detail">' +
        ...
        '<div class="hm-hx-box">' +
          ...
          '<div class="hm-hx-version">HWP/HWPX Engine v1.1.0 · @rhwp/core 0.7.19</div>' +
        '</div>' +
      '</div>';
      ...
      ctx.stage.innerHTML =
        '<div class="hm-fx-detail">' +
          ...
          '<div class="hm-hx-box">' +
            ...
            '<div class="hm-hx-version">HWP/HWPX Engine v1.1.0</div>' +
          '</div>' +
        '</div>';
